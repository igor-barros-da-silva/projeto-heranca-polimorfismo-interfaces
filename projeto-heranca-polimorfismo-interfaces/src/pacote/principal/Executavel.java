...
public class Executavel {
	...
	public static void main(String[] args) {
		...
		/*
		 * /Polimorfismo / Pessoa pessoa = new Aluno(); pessoa = secretario;
		 */

		testePolimorfismo(secretario);
		testePolimorfismo(aluno);
		testePolimorfismo(diretor);
	}

	// O método deve ser stático devido a classe main ser static.
	public static void testePolimorfismo(Pessoa pessoa) {
		System.out.println("Informações sobre o: " + "nome: " + pessoa.getNome() + "salário de:" + pessoa.salario());
	}
